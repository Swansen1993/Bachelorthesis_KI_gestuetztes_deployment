...
# Layer: Database Query (Adapter) - MUTATED
# Antipattern: Excessive Data / In-Memory Paging (Chen et al., 2014)
...
class SqlaUserReader(UserReader):
    ...
    async def list_users(
        ...
        *,
        ...
        # FEHLER (Excessive Data): Kein LIMIT/OFFSET im SQL; lädt stets alle Zeilen in den Speicher
        stmt = select(
            users_table.c.id,
        ...
        total = len(all_rows)
        # Manuelles Python-Slicing im RAM
